...
from ..data.spanish_card_translations import normalize_split_card_name, translate_spanish_name
...
def main() -> int:
    ...
    if not args.skip_validation:
        ...
        logger.info("=" * 70)
        logger.info(
            f"Mismatches fixed: {mismatch_results['fixed_edges']} edges, {mismatch_results['fixed_nodes']} nodes"
        )
