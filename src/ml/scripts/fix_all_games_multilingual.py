...
def fix_all_games_multilingual(
    ...
    try:
        ...
        pokemon_results = fix_pokemon_multilingual(graph_db, min_decks=min_decks, limit=limit)
    ...
    try:
        ...
        yugioh_results = fix_yugioh_multilingual(graph_db, min_decks=min_decks, limit=limit)
