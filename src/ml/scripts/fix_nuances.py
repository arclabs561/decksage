...
def safe_cache_key(
    ...
    if use_hash:
        ...
        safe_use_case_clean = safe_use_case.replace("/", "_").replace("\\", "_").replace(":", "_")[:50]
...
def safe_json_load(path: Path, default: dict[str, Any] | list[Any] | None = None) -> dict[str, Any] | list[Any]:
    """
