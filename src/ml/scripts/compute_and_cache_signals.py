...
def main():
    ...
    try:
        ...
        logger.error(f"Failed to compute sideboard signal: {e}", exc_info=True)
    ...
    try:
        ...
        logger.error(f"Failed to compute temporal signal: {e}", exc_info=True)
    ...
    try:
        ...
        logger.error(f"Failed to compute archetype signals: {e}", exc_info=True)
    ...
    try:
        ...
        logger.error(f"Failed to compute format signals: {e}", exc_info=True)
