    ...
    if agent:
        try:
            ...
            if temporal_eval:
                ...
                judgment.price_volatility_awareness = (
                    4 if temporal_eval.accounts_for_price_volatility else 2
                )
                judgment.ban_timeline_awareness = (
                    4 if temporal_eval.accounts_for_ban_timeline else 2
                )
