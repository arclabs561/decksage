...
def compute_system_health(
    test_set_validation_path: Path | None = None,
    completion_validation_path: Path | None = None,
    ...
    if test_set_validation_path and test_set_validation_path.exists():
        ...
        coverage_pct = queries_with_labels / total_queries * 100 if total_queries > 0 else 0.0
        metrics.append(
            QualityMetric(
