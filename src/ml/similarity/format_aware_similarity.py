...
def format_aware_similarity(
    ...
    *,
    ...
    if format_name is None:
        format_name = (
            get_format_from_query(query_card) or
            get_format_from_query(candidate_card)
        )
    ...
    candidate_name = candidate_card if isinstance(candidate_card, str) else candidate_card.get("name", "")
