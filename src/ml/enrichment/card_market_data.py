#!/usr/bin/env python3
"""
Card Market Data Integration Utilities for capturing and managing card pricing and market data from various sources:
...
class CardPrice:
    ...
    tix: float | None = None  # MTGO tickets
