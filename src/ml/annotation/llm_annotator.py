...
if HAS_PYDANTIC_AI:
    ...
    similarity_agent = make_agent(
        ...
        """You are an expert TCG judge creating similarity annotations.
...
Be precise and justify your score.""",
    ...
    archetype_agent = make_agent(
        ...
        """You are an expert TCG analyst describing archetypes.
...
Consider format context. Modern Burn ≠ Legacy Burn.""",
    ...
    substitution_agent = make_agent(
        SUB_MODEL,
        CardSubstitution,
        """You are an expert TCG player recommending substitutions.
...
If it's better in specific contexts, explain when.""",
    ...
    synergy_agent = make_agent(
        SYN_MODEL,
        DeckSynergy,
        """You are an expert TCG deck builder identifying synergies.
...
Also identify anti-synergies (cards that conflict).""",
    ...
    functionality_agent = make_agent(
        FUNC_MODEL,
        CardFunctionality,
        """You are an expert TCG analyst categorizing cards.
