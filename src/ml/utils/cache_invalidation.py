...
class CacheInvalidationStrategy:
    ...
    def should_invalidate(
        ...
        prompt_version_to_check = (
            current_prompt_version if current_prompt_version is not None else self.prompt_version
        )
        ...
        model_version_to_check = (
            current_model_version if current_model_version is not None else self.model_version
        )
