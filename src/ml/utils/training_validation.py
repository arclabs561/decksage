...
def compare_embeddings(
    ...
    mrr_improvement_pct = (mrr_improvement / baseline_metrics['mrr'] * 100) if baseline_metrics['mrr'] > 0 else 0.0
    
    p_at_k_improvement = improved_metrics['p@k'] - baseline_metrics['p@k']
    p_at_k_improvement_pct = (p_at_k_improvement / baseline_metrics['p@k'] * 100) if baseline_metrics['p@k'] > 0 else 0.0
