        ...
        try:
            ...
            for candidate, scores in modality_scores.items():
                ...
                row = {
                    ...
                    "score_range": max(embed_score, jaccard_score, text_embed_score)
                    - min(embed_score, jaccard_score, text_embed_score),
                    # Query context
                    "query_cmc": query_cmc,
...
def main():
    ...
    parser.add_argument(
        "--method", type=str, default="lightgbm", choices=["lightgbm"], help="Learning method"
    )
    parser.add_argument(
        "--aggregator", type=str, default="rrf", choices=["weighted", "rrf"], help="Aggregator"
    )
