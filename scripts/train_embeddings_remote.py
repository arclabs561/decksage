#!/usr/bin/env python3
"""Training script to run on EC2 instance."""
...
result = subprocess.run(['aws', 's3', 'cp', 'embeddings.wv', f's3://games-collections/embeddings/{OUTPUT_NAME}_pecanpy.wv'])
if result.returncode == 0:
    print("✅ Upload successful!")
    sys.exit(0)
else:
    print(f"❌ Upload failed: {result.returncode}")
    sys.exit(1)
