...
def test_fusion_with_zero_visual_scores():
    ...
    print("Effective weight distribution:")
...
def test_weight_normalization():
    ...
    print(
        f"Original weights: embed={weights.embed}, jaccard={weights.jaccard}, visual={weights.visual_embed}, functional={weights.functional}"
    )
    print(
        f"Normalized weights: embed={normalized.embed:.3f}, jaccard={normalized.jaccard:.3f}, visual={normalized.visual_embed:.3f}, functional={normalized.functional:.3f}"
    )
