...
def main():
    ...
    results["fusion_weighted"] = evaluate_method(
        test_set, weighted_fn, "fusion_weighted", args.top_k
    )
    ...
    print(f"{'=' * 80}")
    print(
        f"{'Method':<20} {'NDCG@10':<12} {'P@10':<12} {'Recall@10':<12} {'Diversity':<12} {'MRR':<12}"
    )
    print(f"{'-' * 80}")
        ...
        for method, result in results.items():
            log_evaluation_run(
                ...
                config={
                    ...
                    "aggregator": "rrf"
                    if "rrf" in method
                    else ("weighted" if "weighted" in method else None),
                },
